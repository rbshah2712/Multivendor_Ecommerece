    ...
    <div class="col-lg-4">
       <div class="card profile-card-2">
        <div class="ml-5 mt-5 pl-5">
            <img class="rounded-circle" src="{{!empty($vendorData->photo)? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no-image.png')}}" alt="{{$vendorData->username}}" width="200px" height="200px">
        </div>
        <div class="card-body pt-5">
            <h5 class="card-title">{{$vendorData->username}}</h5>
            <p class="card-text">{{$vendorData->email}}</p>
        </div>
            ...
            <div class="tab-pane active" id="profile">
                <form method="POST" action="{{ route ('vendor.profile.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" id="username" name="username" value="{{$vendorData->username}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Vendor Shop Name</label>
                        <div class="col-lg-9">
                            <input class="form-control" type="text" id="name" name="name" value="{{$vendorData->name}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Email</label>
                        <div class="col-lg-9">
                            <input class="form-control" type="email" id="email" name="email" value="{{$vendorData->email}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" id="phone"  name="phone" value="{{$vendorData->phone}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label">Address</label>
                        <div class="col-lg-9">
                            <input class="form-control" type="text" id="address" name="address" value="{{$vendorData->address}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" rows="4" id="vendor_short_info" name="vendor_short_info" required="" aria-invalid="true">{{$vendorData->vendor_short_info}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                       ...
                       <div class="col-lg-9">
                           <img id="showImage" class="profile" src="{{ (!empty($vendorData->photo))? url('upload/vendor_images/'.$vendorData->photo):url('upload/no-image.png') }}" alt="{{$vendorData->username}}" width="200px" height="200px">
                       </div>
                   </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label"></label>
