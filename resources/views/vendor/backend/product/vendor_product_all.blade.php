                    ...
                    <span class="badge rounded-pill bg-danger"> {{ round($discount) }}%</span>
                      @endif
                           ...
                           {{--  @if(Auth::user()->can('product.edit'))	 --}}
                             ...
                             <a href="{{ route('vendor.edit.product',$item->id) }}" class="btn btn-info" title="Edit Data"> <i class="fa fa-edit"></i></a>
                            {{-- @endif--}}
                           ...
                           {{--  @endif--}}
                             ...
                             @if($item->status == 1)
                             <a href="{{ route('vendor.product.inactive',$item->id) }}" class="btn btn-primary" title="Inactive"> <i class="fa fa-thumbs-down"></i></a>
                             @else
                             <a href="{{ route('vendor.product.active',$item->id) }}" class="btn btn-primary" title="Active"> <i class="fa fa-thumbs-up"></i> </a>
                             @endif
