...
<div class="card">
  <div class="card-body p-4">
	  ...
	  <hr/>
<form id="productForm" method="post" action="{{ route('vendor.store.product') }}" enctype="multipart/form-data">
			@csrf
        ...
        <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
			   ...
			   <div class="mb-3">
				...
				<textarea id="mytextarea" name="long_descp" rows="6" class="form-control">Hello, World!</textarea>
			  </div>
  ...
  <div class="form-group mb-3">
        ...
        <div class="input-group mb-3">
          <div class="custom-file">
            <input type="file" name="product_thumbnail" class="custom-file-input" id="formFile" onChange="mainThamUrl(this)" >
  ...
  <div class="form-group mb-3">
      ...
      <div class="input-group mb-3">
        <div class="custom-file">
          <input type="file" name="multi_img[]" class="custom-file-input" id="multiImg" multiple>
          <label class="custom-file-label" for="inputGroupFile02">Choose file</label>
        </div>
        <div class="input-group-append">
          <span class="input-group-text">Upload</span>
              ...
              <div class="row g-3">
				...
				<div class="form-group col-md-6">
				  ...
				  <div class="form-group col-12">
					...
					<select name="brand_id" class="custom-select" id="inputProductType">
						<option></option>
				  ...
				  <div class="form-group col-12">
					...
					<select name="category_id" class="custom-select" id="inputVendor">
						<option></option>
				  ...
				  <div class="form-group col-12">
					...
					<select name="subcategory_id" class="custom-select" id="inputCollection">
						<option></option>
