...
<form id="productForm" method="post" action="{{ route('vendor.update.product') }}"  >
			@csrf
       ...
       <div class="form-body mt-4">
        ...
        {{ $products->short_descp }}
			   ...
			   <div class="mb-3">
				...
				<textarea id="mytextarea" name="long_descp" rows="6" class="form-control">
...
<form method="post" action="{{ route('update.product.thumbnail') }}" enctype="multipart/form-data" >
	...
	<div class="card-body">
        ...
        <div class="custom-file">
			...
			<input name="product_thumbnail" class="custom-file-input" type="file" id="formFile">
		</div>
