     ...
     <ul class="navbar-nav align-items-center right-nav-link">
       ...
       <li class="nav-item">
         <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
           <span class="user-profile"><img src="{{!empty($vendorData->photo)? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no-image.png')}}" class="img-circle" alt="user avatar"></span>
         </a>
         <ul class="dropdown-menu dropdown-menu-right">
          <li class="dropdown-item user-details">
           <a href="javaScript:void();">
              <div class="media">
                <div class="avatar"><img class="align-self-start mr-3" src="{{!empty($vendorData->photo)? url('upload/vendor_images/'.$vendorData->photo) : url('upload/no-image.png')}}" alt="user avatar"></div>
               <div class="media-body">
               <h6 class="mt-2 user-title">{{$vendorData->name}} | {{$vendorData->username}}</h6>
               <p class="user-subtitle">{{$vendorData->email}}</p>
               </div>
              </div>
             </a>
           </li>
           <li class="dropdown-divider"></li>
           <li class="dropdown-item"><a href={{route('vendor.profile')}}><i class="icon-user mr-2"></i>Profile</a></li>
           <li class="dropdown-divider"></li>
           <li class="dropdown-item"><a href={{route('vendor.change.password')}}><i class="icon-settings mr-2"></i> Change Password</a></li>
           <li class="dropdown-divider"></li>
           <li class="dropdown-item"><a href={{route('vendor.dashboard')}}><i class="icon-wallet mr-2"></i> Dashboard</a></li>
           <li class="dropdown-divider"></li>
           <li class="dropdown-item"><a href={{route('vendor.logout')}}><i class="icon-power mr-2"></i>Logout</a></li>
         </ul>
       </li>
     </ul>
   </nav>
