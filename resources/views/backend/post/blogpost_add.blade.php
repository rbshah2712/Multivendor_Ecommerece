       ...
       <div class="card">
        ...
        <div class="tab-content p-3">
            ...
            <div class="tab-pane active" id="profile">
                <form method="POST" action="{{ route ('store.blog.post') }}" id="blogpostform" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-9">
                            <textarea class="form-control" rows="4" id="post_short_descp" name="post_short_descp"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-3 col-form-label form-control-label">Blog Post Long Description</label>
                        <div class="form-group col-lg-9">
                            <textarea class="form-control" rows="8" cols="4" id="mytextarea" name="post_long_descp"></textarea>
                        </div>
                    </div>
                    <div class="row">
