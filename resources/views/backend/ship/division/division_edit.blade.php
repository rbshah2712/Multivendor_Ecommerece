       ...
       <div class="card">
        ...
        <div class="tab-content p-3">
            ...
            <div class="tab-pane active" id="profile">
                <form method="POST" action="{{ route ('update.division') }}" id="divisionform">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-9">
                          <input class="form-control" type="text" id="division_name" name="division_name" value={{$division->division_name}}>
                        </div>
                    </div>
                  </div>
