       ...
       <div class="card">
        ...
        <div class="tab-content p-3">
            ...
            <div class="tab-pane active" id="profile">
                <form method="POST" action="{{ route ('store.state') }}" id="stateform">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-9">
                          ...
                          <option value="{{$distr->id}}">{{$distr->district_name}}</option>
                          @endforeach
                          </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-lg-9">
                          <input class="form-control" type="text" id="state_name" name="state_name">
                        </div>
                    </div>
                  </div>
