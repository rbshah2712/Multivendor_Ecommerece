...
<form method="post" action="{{ route('search-by-month')}}">
		...
		<select name="month" class="custom-select" aria-label="Default select example">
	  ...
	  <label class="form-label">Select Year:</label>
		<select name="year_name" class="custom-select" aria-label="Default select example">
 ...
 <form method="post" action="{{ route('search-by-year')}}">
	  ...
	  <label class="form-label">Select Year:</label>
		<select name="year" class="custom-select" aria-label="Default select example">
		<option selected="">Open this select Year</option>
		<option value="2021">2021</option>
		<option value="2022">2022</option>
		<option value="2023">2023</option>
