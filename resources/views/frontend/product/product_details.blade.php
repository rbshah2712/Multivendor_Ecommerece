...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span></span> <a href="shop-grid-right.html">{{$product['category']['category_name']}}</a><span></span>{{$product['brand']['brand_name']}}<span></span>{{$product->product_name}}
        </div>
    </div>
</div>
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    <img src="{{!empty($product->vendor->photo)? url('upload/vendor_images/'.$product->vendor->photo) : url('upload/no-image.png')}}" alt="" />
                            ...
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap hover-up">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html" tabindex="0">
                                                <img class="default-img" src="{{asset($rproduct->product_thumbnail)}}" alt="{{$rproduct->product_name}}" />
                                        ...
                                        @php
                                        $amount = $rproduct->selling_price - $rproduct->discount_price;
                                        $discount = ($amount/$rproduct->selling_price) * 100;
                                        @endphp
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="shop-product-right.html" tabindex="0">{{$rproduct->product_name}}</a></h2>
                                    ...
                                    @else
                                    <div class="product-price">
                                        <span>${{$rproduct->discount_price}}</span>
                                        <span class="old-price">${{$rproduct->selling_price}}</span>
                                    </div>
                                    @endif
                                    </div>
                                </div>
