    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-3">
                    <h5 class="mb-15">{{$breadsubcat->subcategory_name}}</h1>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            ...
                            <div class="product-action-1" style="width: 52%;">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    ...
                    @endphp
                    <li>
                        <a href="{{url('product/category/'.$item->id.'/'.$item->category_slug)}}"> <img src="{{asset($item->category_image)}}" alt="{{$item->category_name}}" />{{$item->category_name}}</a><span class="count">{{count($products)}}</span>
                    </li>
                    @endforeach
                </ul>
            </div>
