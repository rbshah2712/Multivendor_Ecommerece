                ...
                <div class="product-list-small animated animated">
                    ...
                    <article class="row align-items-center hover-up">
                        ...
                        <div class="col-md-8 mb-0">
                            ...
                            @php
$reviewcount = App\Models\Review::where('product_id',$deal->id)->where('status',1)->latest()->get();
$avarage = App\Models\Review::where('product_id',$deal->id)->where('status',1)->avg('rating');
                ...
                <div class="product-list-small animated animated">
                    ...
                    <article class="row align-items-center hover-up">
                        ...
                        <div class="col-md-8 mb-0">
                            ...
                            @php
                            $reviewcount = App\Models\Review::where('product_id',$offer->id)->where('status',1)->latest()->get();
                            $avarage = App\Models\Review::where('product_id',$offer->id)->where('status',1)->avg('rating');
                ...
                <div class="product-list-small animated animated">
                    ...
                    <article class="row align-items-center hover-up">
                        ...
                        <div class="col-md-8 mb-0">
                            ...
                            @php
                            $reviewcount = App\Models\Review::where('product_id',$recent->id)->where('status',1)->latest()->get();
                            $avarage = App\Models\Review::where('product_id',$recent->id)->where('status',1)->avg('rating');
                ...
                <div class="product-list-small animated animated">
                    ...
                    <article class="row align-items-center hover-up">
                        ...
                        <div class="col-md-8 mb-0">
                            ...
                            @php
                            $reviewcount = App\Models\Review::where('product_id',$special->id)->where('status',1)->latest()->get();
                            $avarage = App\Models\Review::where('product_id',$special->id)->where('status',1)->avg('rating');
