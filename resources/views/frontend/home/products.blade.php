    ...
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            ...
            <ul class="nav nav-tabs links" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="nav-tab-one" data-bs-toggle="tab" href="#category{{$cat->id}}" type="button" role="tab" aria-controls="tab-one" aria-selected="true">{{$cat->category_name}}</a>
                </li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="category{{$cat->id}}" role="tabpanel" aria-labelledby="tab-two">
                <div class="row product-grid-4">
                    ...
                    <h5 class="text-danger">No Products to Display</h5>
