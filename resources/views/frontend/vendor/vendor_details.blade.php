                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <span class="font-small text-muted">Sold By <a href="#"><span class="text-danger">Owner</span></a></span>
                            @else
                            <span class="font-small text-muted">Sold By <a href="#"><span class="text-danger">{{$product['vendor']['name']}}</span></a></span>
                            @endif
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                <div class="vendor-logo mb-30">
                    <img src="{{!empty($vendor->photo)? url('upload/vendor_images/'.$vendor->photo) : url('upload/no-image.png')}}" alt="" />
                </div>
                <div class="vendor-info">
                    <div class="product-category">
                        <span class="text-muted">Since {{$vendor->vendor_join}}</span>
                    </div>
                    <h4 class="mb-5"><a href="{{url('vendor/details/'.$vendor->id)}}" class="text-heading">{{$vendor->name}}</a></h4>
                    ...
                    <div class="vendor-info">
                        ...
                        <a href="{{url('vendor/details/'.$vendor->id)}}" class="btn btn-xs">Contact Seller <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
