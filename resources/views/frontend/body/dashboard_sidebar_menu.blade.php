...
<div class="col-md-3">
    <div class="dashboard-menu">
        <ul class="nav flex-column" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{$route == 'user.account.page'? 'active' : ''}}" href="{{route('user.account.page')}}"><i class="fi-rs-user mr-10"></i>My Account</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{$route == 'user.change.password'? 'active' : ''}}" href="{{route('user.change.password')}}"><i class="fi-rs-settings mr-10"></i>Change Password</a>
            </li>
            <li class="nav-item" style="background-color: #ddd;">
