<header class="header-area header-style-1 header-height-2">
    ...
    $allcategories = App\Models\Category::orderBy('category_name','ASC')->latest()->get(); 
    @endphp
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                @else
                                <a href="{{route('login')}}"><span class="lable ml-0"><i class="fi fi-rs-user mr-10"></i>Login</span></a>
