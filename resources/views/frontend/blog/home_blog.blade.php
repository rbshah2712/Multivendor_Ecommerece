                ...
                <div class="loop-grid loop-list pr-30 mb-50">
                    ...
                    <article class="wow fadeIn animated hover-up mb-30 animated">
                        ...
                        <div class="entry-content-2 pl-50">
                            ...
                            <p class="post-exerpt mb-40">{{$item->post_short_description}}</p>
                ...
                <div class="widget-area">
                    ...
                    <div class="sidebar-widget widget-category-2 mb-50">
                        ...
                        <ul>
                            ...
                            @php
                                $posts = App\Models\Blog::where('category_id',$blogcat->id)->get();   
                            @endphp
                            <li>
                                <a href="{{url('post/category/'.$blogcat->id.'/'.$blogcat->blog_category_slug)}}">{{$blogcat->blog_category_name}}</a><span class="count">{{count($posts)}}</span>
                            </li>
                           @endforeach 
                        </ul>
                    </div>
